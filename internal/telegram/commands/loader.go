...
func LoadCommandHandlers(b *bot.Bot, c *container.AppContainer) {
	...
	b.RegisterHandler(bot.HandlerTypeMessageText, "/ouvidoria", bot.MatchTypePrefix, suporte.Handler())
	...
	b.RegisterHandler(bot.HandlerTypeMessageText, "/publi", bot.MatchTypeExact, admin.NoticeChannelsHandler(c), middleware.CheckAdminMiddleware(c))
	b.RegisterHandler(bot.HandlerTypeMessageText, "/maintence", bot.MatchTypeExact, admin.ToggleMaintenceHandler(c), middleware.CheckAdminMiddleware(c))
	b.RegisterHandler(bot.HandlerTypeMessageText, "/info", bot.MatchTypePrefix, admin.GetInfoChannelHandler(c), middleware.CheckAdminMiddleware(c))
	b.RegisterHandler(bot.HandlerTypeMessageText, "/transfer", bot.MatchTypePrefix, admin.RegisterTransferHandler(c), middleware.CheckAdminMiddleware(c))
	b.RegisterHandler(bot.HandlerTypeMessageText, "/user", bot.MatchTypePrefix, admin.GetInfoUserHandler(c), middleware.CheckAdminMiddleware(c))
	b.RegisterHandler(bot.HandlerTypeMessageText, "/remove", bot.MatchTypePrefix, admin.RemoveChannelHandler(c), middleware.CheckAdminMiddleware(c))
	b.RegisterHandler(bot.HandlerTypeMessageText, "/notice", bot.MatchTypePrefix, admin.NoticeCommandHandler(c), middleware.CheckAdminMiddleware(c))
	...
	b.RegisterHandler(bot.HandlerTypeMessageText, "/allusers", bot.MatchTypeExact, admin.NoticeUsersReplyHandler(c), middleware.CheckAdminMiddleware(c))
	b.RegisterHandler(bot.HandlerTypeMessageText, "/allchannels", bot.MatchTypeExact, admin.NoticeChannelsReplyHandler(c), middleware.CheckAdminMiddleware(c))
